 ...
 * - SpringBootTest.WebEnvironment.RANDOM_PORT : random port 환경을 실행하여 테스트
 */
...
class PostsApiControllerTest {
    ...
    public void Posts_수정된다() throws Exception {
        ...
        HttpEntity<PostsUpdateRequestDto> requestEntity = new HttpEntity<>(requestDto); // requestDto를 body로 하는 HttpEntity 객체 생성
